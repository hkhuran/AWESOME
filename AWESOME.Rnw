...
For this assignemt, I have to calculate the number of repository of Java and JavaScript present on the github and plot graphs based on the outcome of results.
